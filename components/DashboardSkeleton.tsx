export default function DashboardSkeleton() {
	return (
		<div className="animate-pulse">
			...
			<div
				className="overflow-hidden rounded-lg border border-gray-200 dark:border-dark-border-default bg-white dark:bg-dark-high shadow-sm">
				{/* Header row skeleton */}
				<div
					className="grid grid-cols-12 gap-4 px-6 py-3 bg-gray-50 dark:bg-dark-elevated border-b border-gray-200 dark:border-dark-border-default">
